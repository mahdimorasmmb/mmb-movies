    ...
    <footer className="flex mt-2  justify-center px-4 shadow-xl bg-transparent text-gray-100 bg-greenHl  ">
      <div className="container py-6">
        ...
        <div className="flex flex-col items-center justify-between mt-6 md:flex-row">
          <div className="mt-6 pb-16 lg:pb-2 w-4/5 lg:w-full mx-auto flex flex-wrap items-center justify-between">
            <a className="link" href="#" data-tippy-content="@facebook_handle">
              <svg
                className="h-6 fill-current text-gray-200 hover:text-greenHd"
                role="img"
                viewBox="0 0 24 24"
